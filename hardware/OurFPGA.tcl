# this tcl script is for my FPGA


# add by cw1997
set_global_assignment -name CYCLONEII_RESERVE_NCEO_AFTER_CONFIGURATION "USE AS REGULAR IO"

set_location_assignment	PIN_176	-to	gpio[0]
set_location_assignment	PIN_181	-to	gpio[1]
set_location_assignment	PIN_162	-to	gpio[2]
set_location_assignment	PIN_179	-to	gpio[3]
